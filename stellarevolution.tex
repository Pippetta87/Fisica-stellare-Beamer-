...
\begin{frame}{Caratteristiche WD}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
\begin{figure}[!ht]
\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,width=0.99\textwidth]{optical-spectrum}\label{fig:optical-spectrum}
\end{figure}
\begin{itemize}

...
\end{block}
\begin{block}{R" parameter}
R2 is ratio of number of star in AGB to stars in HB (lifetime ratio): $=0.12-0.15$ without BP, $0.8-0.14$ with BP - observed R2 in globular cluster ([36], [44]): BP efficiency very low, BP cloud be due to breakdown in instantaneous mixing approx in stellar models when convection setin in late HB stages
\end{block}
\end{frame}

...
\begin{columns}[T]
	\begin{column}{0.55\textwidth}
	\begin{itemize}
	\item AGB we He becomes low enough star move in HDR toward lower $T_e$/ larger $L$ (Asymptotic for $M_*<2.5\msun$): $T_e-L$ relationship similar to RGB (Hayashi track).
	\item He-burning shift to shell around CO-core of increasing mass due to $He\to C/O$ in shell; H-burning shell is turned off due to expansion caused by He-burning shell (T drops) 
	\end{itemize}
	\end{column}
	\begin{column}{0.45\textwidth}
		\begin{figure}[!ht]
...
\begin{frame}{Early AGB: Low mass star}

\end{frame}

\begin{frame}{Index - Nucleosintesi in AGB}

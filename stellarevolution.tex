...
\begin{columns}[T]
	...
	\begin{column}{0.45\textwidth}
	\begin{figure}[!ht]
	\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,height=0.99\textwidth]{5MtoHB}\label{fig:5MtoHB}
	\end{figure}
\end{column}\end{columns}
\end{frame}
...
\begin{columns}[T]
	...
	\begin{column}{0.45\textwidth}
		\begin{figure}[!ht]
			%\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,height=0.37\textheight]{}\label{fig:ffiigg}
		\end{figure}
\end{column}\end{columns}

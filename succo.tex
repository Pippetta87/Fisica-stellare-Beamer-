...
\begin{frame}{Radiation}
    ...
    \begin{align*}
        &F=\int I(\theta)\cos{\theta}\,d\Omega=2\pi\int_{-1}^1I(\mu)\mu\,d\mu\si{\erg\per\second\per\square\cm}\tag{Tot Flux along z}\\
        &\TDy{s}{I}=0, I=\frac{j}{\kappa}=\frac{c}{4\pi}aT^4=\frac{\sigma}{\pi}T^4, U=\frac{2\pi}{c}\int_{-1}^1I\,d\mu=\frac{4\pi}{c}I\tag{LTE}\\
        &\mu\PDy{r}{I_{\nu}}+\PDof{\mu}[(1-\mu^2)\PDy{\mu}{I_{\nu}}]=j_{\nu}-\kappa_{\nu}I_{\nu}\tag{Rad.Transf}\\

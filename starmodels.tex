...
\begin{wordonframe}{\todo{Convezione in esterni stellari}}
...
\section{From micro-physics to thermodynamics: Equazione di stato, opacit\'a}\linkdest{micro2macro}

\begin{multicols}{2}%https://newbedev.com/how-to-explicitly-split-long-toc-in-beamer
    \tableofcontents[currentsection]{lbf}
\end{multicols}

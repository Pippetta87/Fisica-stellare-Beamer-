...
&\epsilon_{PPI}^e(T)=\epsilon_{PPI}^e(T_0=\SI{15}{\mega\ev})(\frac{T}{T_0})\expy{3.9}
\end{align*}
\end{itemize}
	\end{column}
	\begin{column}{0.45\textwidth}
		\begin{figure}[!ht]
	\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,height=0.28\textheight]{He3eq}\label{fig:He3eq}
	\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,height=0.28\textheight]{PP1DHet}\label{fig:PP1DHet}
\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,height=0.28\textheight]{pplifetime}\label{fig:pplifetime}
		\end{figure}
	\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
\begin{figure}[!ht]
	\includegraphics[trim={0cm 0cm 1cm 0cm},clip, keepaspectratio,width=0.9\textwidth]{ppchainsequi}\label{fig:ppchainsequi}
\end{figure}
\end{column}
\end{columns}
\end{frame}

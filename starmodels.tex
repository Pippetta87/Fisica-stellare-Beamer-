...
\begin{wordonframe}{Interazione coulombiana}
La principale correzione che tiene conto dell'interazioni tra particelle \'e dovuta alle interazioni coulombiane.

La presenza dello ione $Z_i$ altera la distribuzione di cariche: la formula di Boltzmann descrive la densit\'a delle particelle con carica Z: $n_Z=\overline{n}_Z\exp{-\frac{Ze\phi}{kT}}$.

Regime di schermaggio debole, $e\phi\ll KT$: potenziale generato dalla nube di cariche attorno a Z $\phi_Z=-\frac{eZ}{r_D}$ con raggio di Debye:
\begin{align*}
...
\begin{align*}
\rho u_c=\frac{1}{2}\int\phi(\vec{r})\rho_c(\vec{r})\,d^3r\to \frac{1}{2}\sum_ZeZ\overline{n}_Z\phi_Z=-e^3\sqrt{\frac{\pi\rho}{kT}}(N_A\zeta)\expy{\frac{3}{2}},\ P_c=\frac{1}{3}\rho u_c
\end{align*}

\end{wordonframe}

\begin{frame}{Equazione di Saha}

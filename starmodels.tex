...
\begin{frame}{Trasporto energia verso la superficie e gradiente termico}
    ...
    \begin{align*}
        \TDy{s}{I_{\nu}}=j_{\nu}\rho-\kappa_{\nu}\rho I_{\nu}\xrightarrow{\times\cos{\theta}\times\int\,d\Omega}&\int_{\Omega}\PDy{r}{I}\cos^2{\theta}\,d\Omega-\int_{\Omega}\frac{1}{r}\PDy{r}{I}\cos{\theta}\sin{\theta}d\,\Omega\\
        &=\int_{\Omega}\rho j\cos{\theta}\Omega-\int_{\Omega}\rho\kappa I\cos{\theta}d\Omega
    \end{align*}
        \end{column}
        \begin{column}{0.3\textwidth}
            \begin{align*}
                &\TDof{s}=\PDof{r}\TDy{s}{r}+\PDof{\theta}\TDy{s}{\theta}\\
                &=\PDof{r}\cos{\theta}-\frac{\sin{\theta}}{r}\PDof{\theta}
            \end{align*}<++>
        \end{column}
    \end{columns}

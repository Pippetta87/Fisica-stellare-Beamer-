...
\begin{wordonframe}{Schema fisico/chimico}
...
\begin{wordonframe}{Relazione tra $P$, $\rho$, $T$}
...
\begin{wordonframe}{Correzioni non-ideali}
...
[Parametro di degenerazione: determinazione (prima)]
		$u_k$ dipende da $\psi$?
		\begin{equation}

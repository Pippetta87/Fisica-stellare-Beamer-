...
\begin{columns}[T]
	\begin{column}{0.5\textwidth}
\begin{itemize}
\item General fading of magnitudes with ages for $t>\SI{e7}{\year}$ of \SI{2}{\mag\per\dex}
\item For K band sudden brightening at \SI{200}{\mega\year} due to AGB
\item Brightening at $t=\SI{e7}{\year}$ due to appearence of He-burning stars
...
\item Integrated colours are unaffected by distance and mass of SSP
\item Age-Metallicity degeneracy for $T>\SI{1}{\giga\year}$: $\frac{\Delta t}{t}\approx1.5-2.0\frac{\Delta Z}{Z}$ for \SI{12}{\giga\year} and solar metallicity. Colour-COlour diagram: searches for color pair where line of constant Z and t are orthogonal.
\end{itemize}
	\end{column}
	\begin{column}{0.5\textwidth}

...
\end{itemize}
\begin{figure}[!ht]\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,width=\textwidth]{Lphasesunresolved}~
\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,width=\textwidth]{unresolvedbandphases}
\end{figure}

...
\begin{equation*}
E_0=[(\frac{\pi}{\hbar})^2(Z_0Z_1e^2)^2(\frac{m_{01}}{2})(KT)^2]^{\frac{1}{3}}=\num{0.1220}[Z_0^2Z_1^2 \frac{M_0M_1}{M_0+M_1}T_9^2]^{\frac{1}{3}}=\SI{5.665}{\kilo\ev}(Z_0^2Z_1^2 \frac{A_0A_1}{A_0+A_1})^{\frac{1}{3}}T_7^{\frac{2}{3}}
\end{equation*}
For increasing charges of projectile/target peak shifts toward higher energies and becomes wider
\begin{equation*}
\Delta E=\SI{4.249}{\kilo\ev}(Z_0^2Z_1^2 \frac{A_0A_1}{A_0+A_1})^{\frac{1}{6}}T_7^{\frac{5}{6}}
\end{equation*}
Q do not contains energy carried by non interacting neutrinos.
...
\begin{figure}[!ht]
    \includegraphics[trim={0cm 0cm 0cm 0cm},clip, keepaspectratio,height=0.32\textheight]{NeBurning-RR}\label{fig:NeBurning-RR}
\end{figure}
        \end{column}
    \end{columns}

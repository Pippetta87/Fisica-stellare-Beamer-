...
\title{Fisica della materia: termodinamica, fisica statistica, ...}
...
\begin{frame}[label={argomenti}]{Fisica della materia}
...
\part{Termodinamica e fisica statistica}\linkdest{thermnstat}
\begin{frame}{this part toc}
\begin{itemize}
\item Statistica BE (Corpo Nero)
\end{itemize}
\end{frame}
\input{thermnstat}

...
\documentclass[8pt,xcolor,fleqn]{beamer}
...
\mode<presentation>{%
        \only<1>{%
           ...
           %            \protect\insertframetitle%
                    \addtocontents{cherryframes}{\protect\mycontentsline{section}{\parbox{0.48\textwidth}{\protect$\bullet$ \protect\insertframetitle}}{}{}}
        }%
    }%
             \else\fi%
...
\section{RegLez e Quad e Refs}
\input{intro}
\section{Memoria, esercizi}\linkdest{succo}
\begin{frame}{Succo's TOC}
    \tableofcontents[currentsection,sectionstyle=show/hide,subsectionstyle=show/show/hide]%shaded
\end{frame}
\input{succo}

\part{Modello Plasma stellare}\linkdest{stellarplasmamodel}
...
\part{Stellar population in the milky way}\linkdest{MW}
%\begin{frame}{this part toc}
%\begin{columns}[T]
%\begin{column}{0.5\textwidth}
%\begin{itemize}

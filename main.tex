...
\begin{frame}[allowframebreaks]{Fisica stellare: argomenti del corso}%label={}
\tableofcontents[soloparti]
\listofcherryframes
\end{frame}

%\begin{wordonframe}{Meta.}
%    list frames insection, \sout{lbf:frameintoc} frameinlbfBOOL-dopo indice delle parti, todo-dopo indice delle parti, keyword-dopo toc della part, must dopo indice parti
%\end{wordonframe}

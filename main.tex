...
\begin{frame}{Fisica stellare: argomenti del corso}%label={}
\tableofcontents[soloparti]
\end{frame}

\begin{wordonframe}{Meta.}
    list frames insection, lbf:frameintoc-dopo indice delle parti, todo-dopo indice delle parti, keyword-dopo toc della part, must dopo indice parti
\end{wordonframe}

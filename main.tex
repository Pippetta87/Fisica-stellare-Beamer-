...
\mode<presentation>{%
        \only<1>{%
           ...
           %            \protect\insertframetitle%
                    \addtocontents{cherryframes}{\protect\mycontentsline{section}{\parbox{0.48\textwidth}{\protect$\bullet$ \protect\insertframetitle}}{}{cherryframes}}
        }%
    }%
             \else\fi%
...
\begin{frame}{my prova}
    \framesubtitle{this is my good provas}
\end{frame}
